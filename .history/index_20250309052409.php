...
<head>
    ...
    <link rel="alternate" type="application/json+oembed" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/oembed.json.php?url=' . urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>" title="Random GIF">
